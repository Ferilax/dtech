const sendApllicationSuccessModal = document.getElementById("send-application-success-modal");
const sendApllicationSubmit = document.getElementById("send-application-submit");

const sendApllicationModal = document.getElementById("send-application-modal");
const sendApllicationTrigger = document.getElementById("send-application-trigger");
...
setModal(sendApllicationSuccessModal);
